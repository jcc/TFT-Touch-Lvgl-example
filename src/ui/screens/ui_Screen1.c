...
void ui_Screen1_screen_init(void)
{
    ...
    // lv_obj_set_width(ui_logo_button, 120);
    // lv_obj_set_height(ui_logo_button, 120);
    // lv_obj_set_x(ui_logo_button, 0);
    // lv_obj_set_y(ui_logo_button, 41);
    ...
    lv_obj_set_y(ui_count_button, 40);
